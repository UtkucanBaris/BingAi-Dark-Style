...
if(document.querySelector("#b_sydConvCont > cib-serp") != null && document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("cib-background").shadowRoot.querySelector("div:nth-child(1)") != null){document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("cib-background").shadowRoot.querySelector("div:nth-child(1)").remove();}
if(document.querySelector("#b_sydConvCont > cib-serp")!=null && document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("cib-background").shadowRoot.querySelector("div:nth-child(1)") != null){document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("cib-background").shadowRoot.querySelector("div:nth-child(1)").remove();}
...
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller > div.fade.top > cib-background").shadowRoot.querySelectorAll(".image").forEach(e => e.remove());
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller > div.fade.top > cib-background").setAttribute("style","background: black !important;background-position: 50% 0%;");
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller > div.fade.bottom > cib-background").shadowRoot.querySelectorAll(".image").forEach(e => e.remove());
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller > div.fade.bottom > cib-background").setAttribute("style","background: black !important;background-position: 50% 0%;");
