...
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller.scroller-enabled > div.fade.top > cib-background").shadowRoot.querySelectorAll(".image").forEach(e => e.remove());
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller.scroller-enabled > div.fade.top > cib-background").setAttribute("style","background: black !important;background-position: 50% 0%;");
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller.scroller-enabled > div.fade.bottom > cib-background").shadowRoot.querySelectorAll(".image").forEach(e => e.remove());
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-conversation-main").shadowRoot.querySelector("div.scroller.scroller-enabled > div.fade.bottom > cib-background").setAttribute("style","background: black !important;background-position: 50% 0%;");
...
document.querySelector("#b_sydConvCont > cib-serp").shadowRoot.querySelector("#cib-action-bar-main").shadowRoot.querySelector("div > div.main-container").setAttribute("style","background:black;outline:1px solid red")// This code is hosted on Github at https://github.com/UtkucanBaris/BingAi-Dark-Style.
